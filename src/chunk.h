...
static uint32_t png_chunks_supported[] = {
    PNG_IHDR, PNG_PLTE, PNG_IDAT, PNG_IEND, 0,
};
 ...
 * [ CHUNK TYPE ]: The 32 bit value in which each byte is an ascii value restricted to the uppercase and lowercase ISO
 * 646 letters. [ CHUNK DATA ]: The chunk data, this can be empty if the chunk type has no data such as IEND chunk. [
