...
static MunitSuite test_suites[] = {{(char *)"blake2b/", blake2b_tests, NULL, 0, MUNIT_SUITE_OPTION_NONE},
...
static MunitSuite test_suite = {(char *)"cha2slide/", NULL, test_suites, 1, MUNIT_SUITE_OPTION_NONE};
